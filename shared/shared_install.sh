...
brew install cask zsh libevent openssl tmux	ag  git wget ncdu graphviz htop python3 ranger diff-so-fancy grv fzf bat fd ruby iftop aws-shell jq ag saws mosh
