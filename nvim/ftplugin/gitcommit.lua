...
function _G.git_commit_fold_text()
	...
	if
		...
		or line:match("^docs")
		or line:match("^style")
		or line:match("^refactor")
		or line:match("^perf")
		or line:match("^test")
		or line:match("^build")
		or line:match("^ci")
		or line:match("^revert")
	then
	...
	if
		line:match("^# [%a%s]+ ")
		or line:match("^# Changes ")
		or line:match("^# Untracked ")
		or line:match("^# Your branch ")
		or line:match("^# On branch ")
		or line:match("^# Not currently ")
...
function _G.unfold_first_commit_message()
	...
	if first_llm_line == 0 then
		...
		vim.cmd("normal! gg")
		local first_commit_line = vim.fn.search(
		...
		if first_commit_line > 0 then
			...
			local second_commit_line = vim.fn.search(
				"^feat\\|^fix\\|^chore\\|^docs\\|^style\\|^refactor\\|^perf\\|^test\\|^build\\|^ci\\|^revert",
				"W",
				0,
				2
