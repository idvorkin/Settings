...
describe("OpenJekyllInBrowser", function()
	...
	it("should open the correct URL for a Jekyll post", function()
		...
		stub(vim_mock.fn, "fnamemodify")
			.on_call_with("/path/to/jekyll/_posts", ":h")
			.returns("/path/to/jekyll")
			.on_call_with("/path/to/jekyll/_posts/2023-01-01-test-post.md", ":~:.")
			.returns("_posts/2023-01-01-test-post.md")
	...
	it("should handle Jekyll posts with permalinks", function()
		...
		stub(vim_mock.fn, "fnamemodify")
			.on_call_with("/path/to/jekyll/_posts", ":h")
			.returns("/path/to/jekyll")
			.on_call_with("/path/to/jekyll/_posts/2023-01-01-test-post-with-permalink.md", ":~:.")
			.returns("_posts/2023-01-01-test-post-with-permalink.md")
	...
	it("should handle files in special directories without permalinks", function()
		...
		stub(vim_mock.fn, "fnamemodify")
			.on_call_with("/path/to/jekyll/_posts", ":h")
			.returns("/path/to/jekyll")
			.on_call_with("/path/to/jekyll/_ig66/test-file.md", ":~:.")
			.returns("_ig66/test-file.md")
		...
		assert.stub(vim_mock.fn.jobstart).was_called_with({ "open", "http://localhost:4000/ig66/test-file" })
	end)

	it("should handle sections and append anchors to the URL", function()
		stub(vim_mock.fn, "expand").returns("/path/to/jekyll/_posts/2023-01-01-test-post.md")
		stub(vim_mock.fn, "finddir").returns("/path/to/jekyll/_posts")
		stub(vim_mock.fn, "fnamemodify")
			.on_call_with("/path/to/jekyll/_posts", ":h")
		...
		-- Mock the current cursor position to be within a section
		stub(vim_mock.fn, "line").returns(7) -- Line number of "## Section 1"
		stub(vim_mock.api, "nvim_buf_get_lines").returns({
			"# Introduction",
			"Content here...",
			"## Section 1",
			"More content...",
		...
		assert
			.stub(vim_mock.fn.jobstart)
			.was_called_with({ "open", "http://localhost:4000/2023-01-01-test-post.html#section-1" })
	end)
end)
